...
def do_dtw_analysis(do_save: bool = True):
    
    save = save_to_file(do_save)
...
def do_kmeans_analysis(do_save: bool = True):
...
def do_kmedoids_analysis(do_save: bool = True):
...
def do_response_analysis(do_save: bool = True):
