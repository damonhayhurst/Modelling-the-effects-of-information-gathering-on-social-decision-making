...
from analyse.response_analysis import get_pid_response_stats_for_clusters, get_response_stats_by_pid, get_trial_count_response_stats_for_clusters, get_trial_id_response_stats_for_clusters, get_trial_response_stats_for_clusters, plot_dwell_times_for_clusters, plot_n_transitions_for_clusters, plot_percent_lies_by_pid, plot_percent_lies_for_clusters
from utils.columns import N_ALT_TRANSITIONS, N_ATT_TRANSITIONS, N_TRANSITIONS, OTHER_LIE, OTHER_TRUTH, PAYNE_INDEX, PID, SELF_LIE, SELF_TRUE, TRIAL, TRIAL_COUNT, TRIAL_ID
from utils.display import display
from utils.paths import AOI_ANALYSIS_CSV, DTW_T_CSV, KMEANS_DWELL_TIMES_PLOT, KMEANS_N_TRANSITIONS_PLOT, KMEANS_PERCENT_LIES_PLOT, PID_DISTANCE_PLOT, PID_DWELL_TIMES_PLOT, PID_N_TRANSITIONS_PLOT, PID_PERCENT_LIES_PLOT, TRIAL_COUNT_DISTANCE_PLOT, TRIAL_COUNT_DWELL_TIMES_PLOT, TRIAL_COUNT_N_TRANSITIONS_PLOT, TRIAL_COUNT_PERCENT_LIES_PLOT, TRIAL_DISTANCE_PLOT, TRIAL_DWELL_TIMES_PLOT, TRIAL_N_TRANSITIONS_PLOT, TRIAL_PERCENT_LIES_PLOT
...
def do_dtw_analysis(input_distance_file: str = DTW_T_CSV,
    ...
    def pid_analysis(big_matrix_df: DataFrame, aoi_analysis_df: DataFrame, max_clusters: int = 20):
        ...
        plot_percent_lies_by_pid(responses_df_by_pid, COLORS)
