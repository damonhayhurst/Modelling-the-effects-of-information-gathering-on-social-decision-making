...
def response_analysis(input_aoi_analysis_file: str = None,
    ...
    plot_percent_lies_by_pid(response_df, colors, to_file=percent_lies_by_pid_plot)
...
def kmeans_analysis(input_aoi_analysis_file: str = None,
    ...
    cluster_df = get_best_fit_kmeans_clusters(for_kmeans_df, max_clusters=max_clusters)
