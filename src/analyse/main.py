...
def kmeans_analysis(input_aoi_analysis_file: str = AOI_ANALYSIS_CSV,
                    ...
                    columns: List[str] = [SELF_LIE, OTHER_LIE, SELF_TRUE, OTHER_TRUTH, TRIAL_COUNT, PAYNE_INDEX],
